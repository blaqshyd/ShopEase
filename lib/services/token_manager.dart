...
class TokenManager {
  ...
  static Future<void> saveTokens({
    ...
    final prefs = await SharedPreferences.getInstance();
    await prefs.setString(accessTokenKey, accessToken ?? accessTokenKey);
    await prefs.setString(refreshTokenKey, refreshToken ?? refreshTokenKey);
    await prefs.setInt(expirationKey, expiration?.millisecondsSinceEpoch ?? 30);
  }
